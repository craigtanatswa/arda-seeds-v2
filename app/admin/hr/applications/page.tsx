...
import { FileText, Download, Eye, LogOut } from "lucide-react"
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <Link href="/admin/hr" className="text-gray-600 hover:text-gray-900">
              Vacancies
            </Link>
            <Link href="/admin/hr/applications" className="text-gray-900 font-medium">
              Applications
            </Link>
          </div>
