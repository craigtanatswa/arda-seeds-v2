  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="text-sm text-gray-500 mb-6">
        ...
        <Link href="/products/sunflower" className="hover:text-green-700 ml-1">Sunflower</Link> / 
      ...
      >
        <ArrowLeft className="mr-2 h-4 w-4" /> Back to Sunflower Products
      </Link>
      ...
      {/* Sunflower-Specific Growing Recommendations */}
      <div className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Sunflower Growing Recommendations</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-green-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-3">Planting Guidelines for Sunflower</h3>
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Planting depth: 2-5 cm</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Row spacing: 60-90 cm between rows, 20-30 cm within rows</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Seeding rate: 5-7 kg/ha (20,000-25,000 plants/ha)</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Plant population: 20,000-30,000 plants per hectare</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Top dressing: Ammonium nitrate (100-150 kg/ha) at 4-6 weeks</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Sunflower responds well to potassium application</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 bg-green-50 p-6 rounded-lg">
          ...
          <ul className="space-y-2 text-gray-700 grid md:grid-cols-2 gap-4">
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <span>Harvest when back of heads turn yellow-brown and seeds are firm</span>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <span>Moisture content at harvest should be 12-15%</span>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <span>Dry seeds to 9-10% moisture for storage</span>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
      ...
      <div className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Other Sunflower Varieties</h2>
          ...
          {sunflowerProducts
            ...
            .map(relatedProduct => (
              <Link 
                ...
                href={`/products/sunflower/${relatedProduct.id}`}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2 flex items-center text-green-600">
                    ...
                    <span className="text-sm">Oil content: Up to 45%</span>
                  </div>
                </div>
              </Link>
            ))
