    ...
    <div className="product-page">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="mb-16 max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 section-header">About Our Sunflower Seeds</h2>
        ...
        <div className="mb-16 bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 md:p-12 border border-green-100">
          <h3 className="text-3xl font-bold mb-8 text-center">Why Choose Our Sunflower Varieties?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <h4 className="font-bold text-xl mb-2">High Oil Content</h4>
              <p className="text-gray-600">Up to 45% oil content for excellent oil yield and profitability</p>
            </div>
            ...
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <p className="text-gray-600">Excellent performance in marginal and dryland areas</p>
            </div>
            ...
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <p className="text-gray-600">Suitable for both commercial and small-scale processing</p>
            </div>
          </div>
        </div>
        ...
        <div className="product-list">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 section-header">Our Sunflower Varieties</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Premium varieties developed for different ecological zones and production systems
            </p>
          </div>
        ...
        <div className="mt-20 relative py-16 px-8 rounded-3xl overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 text-white">
            ...
            <p className="text-xl md:text-2xl mb-10 opacity-95 font-light leading-relaxed">
              Our agronomists can help you select the perfect sunflower variety and provide complete growing recommendations
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <a 
                href="/agronomy/guides/sunflower-guide"
