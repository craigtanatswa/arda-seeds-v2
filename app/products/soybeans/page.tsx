...
export default function SoybeanPage() {
  return (
    <div className="product-page">
      <ProductHero
        title="Soybean Seeds"
        description="Premium soybean varieties with high protein content and disease resistance for optimal production across Zimbabwe."
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="mb-16 max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 section-header">About Our Soybean Seeds</h2>
        ...
        <div className="mb-16 bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 md:p-12 border border-green-100">
          <h3 className="text-3xl font-bold mb-8 text-center">Key Advantages of ARDA Soybean Varieties</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <h4 className="font-bold text-xl mb-2">High Protein</h4>
              <p className="text-gray-600">Superior nutritional value for feed and food markets</p>
            </div>
            ...
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <p className="text-gray-600">Excellent disease resistance packages</p>
            </div>
            ...
            <div className="benefit-card bg-white p-6 rounded-2xl shadow-md">
              ...
              <h4 className="font-bold text-xl mb-2">Zone Adapted</h4>
              <p className="text-gray-600">Varieties for all ecological zones</p>
            </div>
          </div>
        </div>
        ...
        <div className="product-list">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 section-header">Our Soybean Varieties</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Premium varieties developed for consistent high yields and market preference
            </p>
          </div>
        ...
        <div className="mt-20 relative py-16 px-8 rounded-3xl overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 text-white">
            ...
            <p className="text-xl md:text-2xl mb-10 opacity-95 font-light leading-relaxed">
              Our agronomists can help you select the perfect soybean variety and provide complete growing recommendations
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <a 
                href="/agronomy/guides/soybean-guide"
