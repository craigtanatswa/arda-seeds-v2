  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="text-sm text-gray-500 mb-6">
        ...
        <Link href="/products/cowpeas" className="hover:text-green-700 ml-1">Cowpeas</Link> / 
        <span className="text-gray-900 ml-1">{product.name}</span>
      </div>

      {/* Back Button */}
      <Link 
        href="/products/cowpeas" 
        className="inline-flex items-center text-green-700 mb-6 hover:text-green-800"
      >
        <ArrowLeft className="mr-2 h-4 w-4" /> Back to Cowpea Products
      </Link>

      {/* Product Content - Same structure as wheat product page */}
      ...
      {/* Crop-Specific Growing Recommendations */}
      <div className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Cowpea Growing Recommendations</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-green-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-3">Planting Guidelines for Cowpea</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Optimal planting time: November to January</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Planting depth: 2-5 cm in heavy soils, 4-6 cm in light soils</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Row spacing: 45-60 cm between rows, 10-15 cm within rows</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Seeding rate: 15-20 kg/ha (spacing dependent)</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Plant population: 150,000-200,000 plants per hectare</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Prefers well-drained sandy loam to loam soils</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Basal fertilizer: Compound D (100-200 kg/ha) at planting</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Phosphorus is particularly important for cowpea</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Responds well to inoculation with appropriate rhizobia</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Other Cowpea Varieties</h2>
          ...
          {cowpeaProducts
            ...
            .map(relatedProduct => (
              <Link 
                ...
                href={`/products/cowpeas/${relatedProduct.id}`}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2 flex items-center text-green-600">
                    ...
                    <span className="text-sm">Early maturity: {relatedProduct.maturity}</span>
                  </div>
                </div>
              </Link>
            ))
